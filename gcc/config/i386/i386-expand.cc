...
void
ix86_expand_crc_pclmulqdq (scalar_mode crc_mode,
			     ...
			     rtx *operands)
{
  ...
  emit_move_insn (operands[0], gen_lowpart (crc_mode, a0));
}
...
void
ix86_expand_reversed_crc_pclmulqdq (scalar_mode crc_mode,
				    scalar_mode data_mode,
				    rtx *operands)
{
  /* Check and keep arguments.  */
