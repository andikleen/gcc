...
public:
  ...
  static void tune(size_t buffer_size_, size_t line_record_size_) {
...
size_t file_cache_slot::buffer_size = 4 * 1024;
size_t file_cache_slot::line_record_size = 100;

/* Tune file_cache.  */
void
file_cache::tune (size_t num_file_slots_, size_t buffer_size, size_t lines)
{
  num_file_slots = num_file_slots_;
  file_cache_slot::tune (buffer_size, lines);
}
